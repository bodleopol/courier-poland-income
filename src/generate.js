  ...
  for (const p of staticPages) {
    try {
      ...
      if (!pContent.includes('<html')) {
        ...
        let desc = 'Rybezh';
        if (p === 'rent.html') {
          title = 'Оренда транспорту для роботи в Польщі – Авто, Мото, Вело';
          desc = 'Реальна оренда економного транспорту для курʼєрів та таксі. Скутери (від 2л/100км), надійні авто на газу та велосипеди з доставкою. Без прихованих платежів.';
        }
