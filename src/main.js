...
(function() {
  ...
  const translations = {
    ...
    'rent.title': { ua: 'Оренда транспорту', pl: 'Wynajem pojazdów', ru: 'Аренда транспорта', en: 'Vehicle Rental'},
    'rent.subtitle': { ua: 'Надійний транспорт для роботи та особистих потреб. Велосипеди, скутери, мотоцикли та авто на вигідних умовах.', pl: 'Niezawodny transport do pracy i potrzeb osobistych. Rowery, skutery, motocykle i samochody na korzystnych warunkach.', ru: 'Надежный транспорт для работы и личных нужд. Велосипеды, скутеры, мотоциклы и автомобили на выгодных условиях.', en: 'Reliable transport for work and personal needs. Bicycles, scooters, motorcycles and cars on favorable terms.'},
    ...
    'rent.bike': { ua: 'Велосипед', pl: 'Rower', ru: 'Велосипед', en: 'Bicycle'},
    'rent.bike.desc': { ua: 'Легкий та екологічний транспорт. Ідеально підходить для коротких поїздок та роботи кур\'єром (в наявності 2 шт).', pl: 'Lekki i ekologiczny transport. Idealny na krótkie wycieczki i do pracy jako kurier (w magazynie 2 szt.).', ru: 'Легкий и экологичный транспорт. Идеально подходит для коротких поездок и работы курьером (в наличии 2 шт).', en: 'Light and eco-friendly transport. Ideal for short trips and courier work (2 items available).'},
    'rent.scooter': { ua: 'Скутер Lifan', pl: 'Skuter Lifan', ru: 'Скутер Lifan', en: 'Scooter Lifan'},
    'rent.scooter.desc': { ua: 'Економічний та маневровий скутер Lifan. Відмінний вибір для міста (в наявності 1 шт).', pl: 'Ekonomiczny i zwrotny skuter Lifan. Doskonały wybór do miasta (w magazynie 1 szt.).', ru: 'Экономичный и маневренный скутер Lifan. Отличный выбор для города (в наличии 1 шт).', en: 'Economical and maneuverable Lifan scooter. Excellent choice for the city (1 item available).'},
    'rent.moto': { ua: 'Дорожній мотоцикл', pl: 'Motocykl drogowy', ru: 'Дорожный мотоцикл', en: 'Road Motorcycle'},
    'rent.moto.desc': { ua: 'Потужний дорожній мотоцикл для швидких переміщень. Надійна техніка для впевненої їзди (в наявності 3 шт).', pl: 'Potężny motocykl drogowy do szybkich podróży. Niezawodny sprzęt do pewnej jazdy (w magazynie 3 szt.).', ru: 'Мощный дорожный мотоцикл для быстрых перемещений. Надежная техника для уверенной езды (в наличии 3 шт).', en: 'Powerful road motorcycle for fast travel. Reliable equipment for confident riding (3 items available).'},
    'rent.car': { ua: 'Автомобіль Kia Solito 2026', pl: 'Samochód Kia Solito 2026', ru: 'Автомобиль Kia Solito 2026', en: 'Car Kia Solito 2026'},
    'rent.car.desc': { ua: 'Абсолютно новий автомобіль 2026 року (0 км пробіг) на газу. Комфорт та максимальна економія пального. Ідеально для таксі.', pl: 'Zupełnie nowy samochód z 2026 roku (przebieg 0 km) na gazie. Komfort i maksymalna oszczędność paliwa. Idealny na taksówkę.', ru: 'Абсолютно новый автомобиль 2026 года (0 км пробег) на газу. Комфорт и максимальная экономия топлива. Идеально для такси.', en: 'Brand new 2026 car (0 km mileage) on gas. Comfort and maximum fuel economy. Ideal for a taxi.'},
    ...
    'rent.faq.title': { ua: 'FAQ: Закон про оренду в Польщі', pl: 'FAQ: Prawo najmu w Polsce', ru: 'FAQ: Закон об аренде в Польше', en: 'FAQ: Polish Rental Law'},
    'rent.faq.q1': { ua: 'Які документи потрібні для оренди?', pl: 'Jakie dokumenty są potrzebne do wynajmu?', ru: 'Какие документы нужны для аренды?', en: 'What documents are required for rent?'},
    'rent.faq.a1': { ua: 'Для оренди майна зазвичай потрібен дійсний паспорт (або карта побиту) та підписання договору. У деяких випадках можуть попросити заставу (кауцію).', pl: 'Do wynajmu nieruchomości zazwyczaj wymagany jest ważny paszport (lub karta pobytu) oraz podpisanie umowy. W niektórych przypadkach może być wymagana kaucja.', ru: 'Для аренды имущества обычно требуется действительный паспорт (или карта побыту) и подписание договора. В некоторых случаях могут попросить залог (кауцию).', en: 'To rent property, you usually need a valid passport (or residence card) and a signed contract. In some cases, a deposit (kaucja) may be requested.'},
    'rent.faq.q2': { ua: 'Що таке кауція (kaucja)?', pl: 'Co to jest kaucja?', ru: 'Что такое кауция (kaucja)?', en: 'What is a deposit (kaucja)?'},
    'rent.faq.a2': { ua: 'Кауція — це поворотний депозит, який слугує фінансовою гарантією для орендодавця на випадок пошкодження майна або несплати. Вона повертається після закінчення терміну дії договору.', pl: 'Kaucja to zwrotny depozyt, który służy jako gwarancja finansowa dla wynajmującego na wypadek zniszczenia mienia lub braku płatności. Zwracana jest po wygaśnięciu umowy.', ru: 'Кауция — это возвратный депозит, который служит финансовой гарантией для арендодателя на случай повреждения имущества или неуплаты. Она возвращается после окончания срока действия договора.', en: 'A deposit is a refundable amount that serves as a financial guarantee for the landlord in case of property damage or non-payment. It is returned after the contract expires.'},
    'rent.faq.q3': { ua: 'Чи можу я розірвати договір достроково?', pl: 'Czy mogę wcześniej rozwiązać umowę?', ru: 'Могу ли я расторгнуть договор досрочно?', en: 'Can I terminate the contract early?'},
    'rent.faq.a3': { ua: 'Дострокове розірвання залежить від типу договору. Строкові договори можна розірвати лише у випадках, прямо зазначених у договорі. Безстрокові договори мають визначений законом період попередження.', pl: 'Wcześniejsze rozwiązanie umowy zależy od jej rodzaju. Umowy na czas oznaczony można rozwiązać tylko w przypadkach określonych w umowie. Umowy na czas nieoznaczony mają ustawowy okres wypowiedzenia.', ru: 'Досрочное расторжение зависит от типа договора. Срочные договоры можно расторгнуть только в случаях, прямо указанных в договоре. Бессрочные договоры имеют установленный законом период уведомления.', en: 'Early termination depends on the type of contract. Fixed-term contracts can only be terminated in cases explicitly stated in the contract. Indefinite contracts have a statutory notice period.'},
    'rent.faq.q4': { ua: 'Хто оплачує ремонт під час оренди?', pl: 'Kto płaci za naprawy podczas wynajmu?', ru: 'Кто оплачивает ремонт во время аренды?', en: 'Who pays for repairs during the rental?'},
    'rent.faq.a4': { ua: 'Дрібний поточний ремонт зазвичай є обов\'язком орендаря. Капітальний ремонт або усунення серйозних несправностей, які виникли не з вини орендаря, покриває орендодавець.', pl: 'Drobne naprawy bieżące zazwyczaj należą do obowiązków najemcy. Poważne naprawy lub usuwanie usterek, które nie wynikają z winy najemcy, pokrywa wynajmujący.', ru: 'Мелкий текущий ремонт обычно является обязанностью арендатора. Капитальный ремонт или устранение серьезных неисправностей, возникших не по вине арендатора, покрывает арендодатель.', en: 'Minor routine repairs are usually the responsibility of the tenant. Major repairs or fixing serious faults not caused by the tenant are covered by the landlord.'},
    'rent.faq.q5': { ua: 'Які права потрібні для керування скутером?', pl: 'Jakie prawo jazdy jest potrzebne do prowadzenia skutera?', ru: 'Какие права нужны для управления скутером?', en: 'What license is required to drive a scooter?'},
    'rent.faq.a5': { ua: 'Згідно з польським законодавством, для керування скутером об\'ємом до 50 куб.см потрібні водійські права категорії AM або B. Якщо ви народилися до 19 січня 1995 року, ви можете керувати ним лише за наявності посвідчення особи.', pl: 'Zgodnie z polskim prawem do prowadzenia skutera o pojemności do 50 cm sześc. wymagane jest prawo jazdy kategorii AM lub B. Jeśli urodziłeś się przed 19 stycznia 1995 r., możesz nim kierować posiadając jedynie dowód osobisty.', ru: 'Согласно польскому законодательству, для управления скутером объемом до 50 куб.см требуются водительские права категории AM или B. Если вы родились до 19 января 1995 года, вы можете управлять им только при наличии удостоверения личности.', en: 'According to Polish law, driving a scooter up to 50cc requires an AM or B category driving license. If you were born before January 19, 1995, you can drive it using only your ID card.'},
    'rent.faq.q6': { ua: 'Чи обов\'язковий шолом при їзді на велосипеді чи скутері?', pl: 'Czy kask jest obowiązkowy podczas jazdy na rowerze lub skuterze?', ru: 'Обязателен ли шлем при езде на велосипеде или скутере?', en: 'Is a helmet mandatory when riding a bicycle or scooter?'},
    'rent.faq.a6': { ua: 'Для водіїв скутерів та мотоциклів шолом є обов\'язковим за законом. Для велосипедистів шолом не є юридично обов\'язковим, але настійно рекомендується для безпеки.', pl: 'Dla kierowców skuterów i motocykli kask jest prawnie obowiązkowy. Dla rowerzystów kask nie jest prawnie wymagany, ale jest wysoce zalecany ze względów bezpieczeństwa.', ru: 'Для водителей скутеров и мотоциклов шлем обязателен по закону. Для велосипедистов шлем не является юридически обязательным, но настоятельно рекомендуется для безопасности.', en: 'For scooter and motorcycle drivers, a helmet is legally mandatory. For cyclists, a helmet is not legally required but is highly recommended for safety.'},
    'rent.faq.q7': { ua: 'Чи можна їздити на велосипеді по тротуару?', pl: 'Czy można jeździć rowerem po chodniku?', ru: 'Можно ли ездить на велосипеде по тротуару?', en: 'Can I ride a bicycle on the sidewalk?'},
    'rent.faq.a7': { ua: 'Як правило, їзда на велосипеді по тротуару в Польщі заборонена. Винятки становлять випадки: коли ви супроводжуєте дитину до 10 років на велосипеді; тротуар має ширину більше 2 метрів, а ліміт швидкості на дорозі перевищує 50 км/год; або за дуже поганих погодних умов.', pl: 'Zasadniczo jazda na rowerze po chodniku w Polsce jest zabroniona. Wyjątki to: opieka nad dzieckiem do lat 10 na rowerze; chodnik ma szerokość powyżej 2 metrów, a ograniczenie prędkości na drodze wynosi ponad 50 km/h; lub w przypadku bardzo złych warunków pogodowych.', ru: 'Как правило, езда на велосипеде по тротуару в Польше запрещена. Исключения составляют случаи: когда вы сопровождаете ребенка до 10 лет на велосипеде; тротуар имеет ширину более 2 метров, а лимит скорости на дороге превышает 50 км/ч; или при очень плохих погодных условиях.', en: 'Generally, cycling on the sidewalk is prohibited in Poland. Exceptions include: when accompanying a child up to 10 years old on a bicycle; the sidewalk is over 2 meters wide and the road speed limit is over 50 km/h; or during very poor weather conditions.'},
