...
(function() {
  ...
  const translations = {
    ...
    'bogdan.intro': {"ua":"Я українець, живу у Львові та працюю в міжнародній логістиці. Як операційний директор я звик будувати надійні процеси, а як інвестор Rybezh — тримати фокус на чесності, прозорості й довгій стійкості проєкту.","pl":"Jestem Ukraińcem, mieszkam we Lwowie i pracuję w międzynarodowej logistyce. Jako dyrektor operacyjny buduję rzetelne procesy, a jako inwestor Rybezh dbam o uczciwość, przejrzystość i długoterminową stabilność projektu.","ru":"Я украинец, живу во Львове и работаю в международной логистике. Как операционный директор я привык строить надежные процессы, а как инвестор Rybezh держать фокус на честности, прозрачности и устойчивости проекта.","en":"I am Ukrainian, based in Lviv and working in international logistics. As a COO, I build reliable processes, and as a Rybezh investor I stay focused on honesty, transparency, and long-term stability."},
    ...
    'bogdan.mission': {"ua":"Після досвіду 2014 року для мене принципово, щоб людина ще до виїзду знала реальні умови роботи. У Rybezh я підтримую підхід без прикрашання: чесний опис вакансій, зрозумілі процеси і повага до людської гідності в кожній взаємодії.","pl":"Po doświadczeniu 2014 roku kluczowe jest dla mnie to, aby człowiek znał realne warunki pracy jeszcze przed wyjazdem. W Rybezh wspieram podejście bez upiększeń: uczciwe opisy ofert, jasne procesy i szacunek do godności człowieka w każdej interakcji.","ru":"После опыта 2014 года для меня принципиально, чтобы человек ещё до выезда понимал реальные условия работы. В Rybezh я поддерживаю подход без украшений: честное описание вакансий, понятные процессы и уважение к человеческому достоинству в каждом взаимодействии.","en":"After the experience of 2014, it is essential to me that people understand real working conditions before they leave. At Rybezh, I support a no-polish approach: honest vacancy descriptions, clear processes, and respect for human dignity in every interaction."},
    ...
    'emp.form.email_ph': {"ua":"kontakt@company.com","pl":"kontakt@firma.pl","ru":"kontakt@company.com","en":"contact@company.com"},
    ...
    'emp.form.umowa_o_prace': {"ua":"Трудовий договір (Umowa o pracę)","pl":"Umowa o pracę","ru":"Трудовой договор (Umowa o pracę)","en":"Employment contract (Umowa o pracę)"},
    'emp.form.umowa_zlecenie': {"ua":"Договір доручення (Umowa zlecenie)","pl":"Umowa zlecenie","ru":"Договор поручения (Umowa zlecenie)","en":"Mandate contract (Umowa zlecenie)"},
