...
(function() {
  ...
  const translations = {
    ...
    '404.jobs_all': {"ua":"Всі вакансії","pl":"Wszystkie oferty","ru":"Все вакансии","en":"All Vacancies"},
    ...
    '404.link.jobs': {"ua":"📋 Актуальні вакансії","pl":"📋 Aktualne oferty pracy","ru":"📋 Актуальные вакансии","en":"📋 Current vacancies"},
    ...
    'about.meta_description': {"ua":"Дізнайтесь більше про Rybezh. Наша команда, професійна експертиза, місія та інноваційний підхід до безпечного працевлаштування в Польщі.","pl":"Dowiedz się więcej o Rybezh. Nasz zespół, profesjonalne doświadczenie, misja i innowacyjne podejście do bezpiecznego zatrudnienia w Polsce.","ru":"Узнайте больше о Rybezh. Наша команда, профессиональная экспертиза, миссия и инновационный подход к безопасному трудоустройству в Польше.","en":"Learn more about Rybezh. Our team, professional expertise, mission, and innovative approach to safe employment in Poland."},
    'about.meta_title': {"ua":"Про компанію Rybezh — Провідна платформа працевлаштування","pl":"O firmie Rybezh — Wiodąca platforma zatrudnienia","ru":"О компании Rybezh — Ведущая платформа трудоустройства","en":"About Rybezh — Leading Employment Platform"},
    ...
    'about.step1': {"ua":"1️⃣ Консультація (Безкоштовно)","pl":"1️⃣ Konsultacja (Bezpłatnie)","en":"1️⃣ Application & Consultation","ru":"1️⃣ Консультация (Бесплатно)"},
    'about.step2': {"ua":"2️⃣ Підбір вакансії","pl":"2️⃣ Dobór oferty pracy","en":"2️⃣ Job Matching","ru":"2️⃣ Подбор вакансии"},
    'about.step3': {"ua":"3️⃣ Оформлення документів","pl":"3️⃣ Formalizacja dokumentów","en":"3️⃣ Paperwork","ru":"3️⃣ Оформление документов"},
    'about.step4': {"ua":"4️⃣ Початок роботи","pl":"4️⃣ Rozpoczęcie pracy","en":"4️⃣ Moving & Adaptation","ru":"4️⃣ Начало работы"},
    'about.text': {"ua":"<strong>Rybezh</strong> — це команда професіоналів, яка допомагає українцям та іноземцям знайти стабільну роботу у Польщі. Ми співпрацюємо з роботодавцями в різних сферах.","pl":"<strong>Rybezh</strong> to zespół profesjonalistów pomagający Ukraińcom i obcokrajowcom znaleźć stabilną pracę w Polsce. Współpracujemy z pracodawcami w różnych branżach.","ru":"<strong>Rybezh</strong> — это команда профессионалов, которая помогает украинцам и иностранцам найти стабильную работу в Польше. Мы сотрудничаем с работодателями в разных сферах.","en":"<strong>Rybezh</strong> is a team of professionals that helps Ukrainians and foreigners find stable work in Poland. We cooperate with employers in various fields."},
    ...
    'about.why_text': {"ua":"Ми пропонуємо лише перевірені вакансії, допомагаємо з легалізацією та надаємо підтримку 24/7. З нами ви можете бути впевнені у своєму завтрашньому дні.","pl":"Oferujemy tylko sprawdzone oferty pracy, pomagamy w legalizacji i zapewniamy wsparcie 24/7. Z nami możesz być pewny swojego jutra.","ru":"Мы предлагаем только проверенные вакансии, помогаем с легализацией и предоставляем поддержку 24/7. С нами вы можете быть уверены в своём завтрашнем дне.","en":"We only offer verified jobs, help with legalization and provide 24/7 support. With us, you can be sure of your future."},
    ...
    'article.cta.title': {"ua":"Готові почати?","pl":"Gotowy, by zacząć?","ru":"Готовы начать?","en":"Ready to start?"},
    'article.main.title': {"ua":"Як почати роботу в Польщі за 3 дні","pl":"Jak rozpocząć pracę w Polsce w 3 dni","ru":"Как начать работу в Польше за 3 дня","en":"How to start working in Poland in 3 days"},
    'article.mistake.communication': {"ua":"❌ Ігнорувати базову польську","pl":"❌ Ignorować podstawowy polski","ru":"❌ Игнорировать базовый польский","en":"❌ Ignore basic Polish"},
    'article.mistake.safety': {"ua":"❌ Не читати договір до підпису","pl":"❌ Nie czytać umowy przed podpisaniem","ru":"❌ Не читать договор до подписи","en":"❌ Do not read the contract before signing"},
    'article.mistake.too_many': {"ua":"❌ Подавати заявки без перевірки умов","pl":"❌ Wysyłać zgłoszenia bez sprawdzenia warunków","ru":"❌ Подавать заявки без проверки условий","en":"❌ Submit applications without checking conditions"},
    'article.related': {"ua":"📚 Читайте також:","pl":"📚 Zobacz też:","ru":"📚 Читайте также:","en":"📚 Read also:"},
    ...
    'article.step1': {"ua":"Крок 1: Перевірте базові документи","pl":"Krok 1: Sprawdź podstawowe dokumenty","ru":"Шаг 1: Проверьте базовые документы","en":"Step 1: Check the basic documents"},
    'article.step2': {"ua":"Крок 2: Заповніть анкету на Rybezh","pl":"Krok 2: Wypełnij formularz Rybezh","ru":"Шаг 2: Заполните анкету на Rybezh","en":"Step 2: Fill out the form on Rybezh"},
    'article.step3': {"ua":"Крок 3: Отримайте PESEL (за потреби)","pl":"Krok 3: Uzyskaj PESEL (jeśli potrzebne)","ru":"Шаг 3: Получите PESEL (при необходимости)","en":"Step 3: Get a PESEL (if needed)"},
    'article.step4': {"ua":"Крок 4: Оберіть вакансії та надішліть заявки","pl":"Krok 4: Wybierz oferty i wyślij zgłoszenia","ru":"Шаг 4: Выберите вакансии и отправьте заявки","en":"Step 4: Select vacancies and send applications"},
    'article.step5': {"ua":"Крок 5: Підготуйтеся до співбесіди","pl":"Krok 5: Przygotuj się do rozmowy","ru":"Шаг 5: Подготовьтесь к собеседованию","en":"Step 5: Prepare for the interview"},
    'article.step6': {"ua":"Крок 6: Пройдіть перший робочий день","pl":"Krok 6: Przejdź pierwszy dzień pracy","ru":"Шаг 6: Пройдите первый рабочий день","en":"Step 6: Complete the first working day"},
    'article.step7': {"ua":"Крок 7: Уточніть графік виплат","pl":"Krok 7: Ustal harmonogram wypłat","ru":"Шаг 7: Уточните график выплат","en":"Step 7: Specify the payment schedule"},
    'article.tip.phone': {"ua":"📱 Тримайте зв’язок з роботодавцем","pl":"📱 Utrzymuj kontakt z pracodawcą","ru":"📱 Держите связь с работодателем","en":"📱 Keep in touch with the employer"},
    ...
    'article.tip.routes': {"ua":"📍 Обирайте вакансії з зручною логістикою","pl":"📍 Wybieraj oferty z wygodną logistyką","ru":"📍 Выбирайте вакансии с удобной логистикой","en":"📍 Choose vacancies with convenient logistics"},
    ...
    'aside.text': {"ua":"Ми допомагаємо з документами, легалізацією та підбором вакансій. Заявки обробляємо протягом 24 годин.","pl":"Pomagamy z dokumentami, legalizacją i doborem ofert. Zgłoszenia przetwarzamy w ciągu 24 godzin.","ru":"Мы помогаем с документами, легализацией и подбором вакансий. Заявки обрабатываем в течение 24 часов.","en":"We help with documents, legalization and job selection. Applications are processed within 24 hours."},
    ...
    'bogdan.expertise': {"ua":"Міжнародна логістика, Інвестиції, Операційний менеджмент","pl":"Międzynarodowa logistyka, Inwestycje, Zarządzanie operacyjne","ru":"Международная логистика, Инвестиции, Операционный менеджмент","en":"International logistics, Investments, Operations management"},
    ...
    'bogdan.gallery.moto2': {"ua":"Дорога — це місце сили","pl":"Droga jest miejscem mocy","ru":"Дорога — это место силы","en":"The road is a place of power"},
    'bogdan.intro': {"ua":"Я українець, проживаю у прекрасному місті Львів. Працюючи операційним директором у міжнародній логістичній компанії, я навчився будувати надійні та прозорі процеси. Цей досвід допомагає мені як Інвестору гарантувати стабільність проекту Rybezh.","pl":"Jestem Ukraińcem, mieszkam w pięknym Lwowie. Pracując jako dyrektor operacyjny w międzynarodowej firmie logistycznej, nauczyłem się budować rzetelne i przejrzyste procesy. To doświadczenie pomaga mi jako Inwestorowi gwarantować stabilność projektu Rybezh.","ru":"Я украинец, проживаю в прекрасном городе Львов. Работая операционным директором в международной логистической компании, я научился строить надежные и прозрачные процессы. Этот опыт помогает мне как Инвестору гарантировать стабильность проекта Rybezh.","en":"I am Ukrainian, living in the beautiful city of Lviv. Working as a COO in an international logistics company, I have learned to build reliable and transparent processes. This experience helps me as an Investor to guarantee the stability of the Rybezh project."},
    ...
    'bogdan.meta_description': {"ua":"Богдан Тютенко — Операційний директор міжнародної логістичної компанії та Інвестор платформи Rybezh. Проживає у місті Львів.","pl":"Bohdan Tiutenko — Dyrektor operacyjny międzynarodowej firmy logistycznej i Inwestor platformy Rybezh. Mieszka we Lwowie.","ru":"Богдан Тютенко — Операционный директор международной логистической компании и Инвестор платформы Rybezh. Проживает в городе Львов.","en":"Bohdan Tiutenko — COO of an international logistics company and Investor of the Rybezh platform. Lives in Lviv."},
    'bogdan.meta_title': {"ua":"Богдан Тютенко — Операційний директор та Інвестор","pl":"Bohdan Tiutenko — Dyrektor operacyjny i Inwestor","ru":"Богдан Тютенко — Операционный директор и Инвестор","en":"Bohdan Tiutenko — COO & Investor"},
    ...
    'bogdan.moments_title': {"ua":"Цікаві моменти з життя","pl":"Ciekawe momenty z życia","ru":"Интересные моменты из жизни","en":"Interesting life moments"},
    'bogdan.moment1': {
      "ua":"Богдан Тютенко — людина з непересічним життєвим досвідом. У 2014 році він брав участь в обороні України на Донбасі, про що згодом написав книгу «Хаос і надія: Донбас 2014». Цей досвід загартував його характер та навчив цінувати кожну мить життя.",
      "pl":"Bohdan Tiutenko to człowiek o niezwykłym doświadczeniu życiowym. W 2014 roku brał udział w obronie Ukrainy w Donbasie, o czym napisał później książkę „Chaos i nadzieja: Donbas 2014”. Doświadczenie to zahartowało jego charakter i nauczyło go doceniać każdą chwilę życia.",
      "ru":"Богдан Тютенко — человек с незаурядным жизненным опытом. В 2014 году он участвовал в обороне Украины на Донбассе, о чем впоследствии написал книгу «Хаос и надежда: Донбасс 2014». Этот опыт закалил его характер и научил ценить каждое мгновение жизни.",
      "en":"Bohdan Tiutenko is a man with extraordinary life experience. In 2014, he participated in the defense of Ukraine in Donbas, about which he later wrote the book 'Chaos and Hope: Donbas 2014'. This experience hardened his character and taught him to appreciate every moment of life."
    },
    'bogdan.moment2': {
      "ua":"Окрім професійної діяльності, Богдан захоплюється мотоциклами, що є для нього символом свободи та швидкості. Також він дуже любить тварин, особливо свого вірного собаку, який супроводжує його у багатьох пригодах.",
      "pl":"Poza działalnością zawodową Bohdan pasjonuje się motocyklami, które są dla niego symbolem wolności i szybkości. Bardzo kocha też zwierzęta, a zwłaszcza swojego wiernego psa, który towarzyszy mu w wielu przygodach.",
      "ru":"Помимо профессиональной деятельности, Богдан увлекается мотоциклами, что является для него символом свободы и скорости. Также он очень любит животных, особенно свою верную собаку, которая сопровождает его во многих приключениях.",
      "en":"In addition to his professional activities, Bohdan is passionate about motorcycles, which for him are a symbol of freedom and speed. He also loves animals very much, especially his faithful dog, who accompanies him in many adventures."
    },
    'bogdan.moment3': {
      "ua":"Його шлях від програміста до операційного директора та інвестора є прикладом постійного самовдосконалення та відданості своїй справі. Богдан вірить, що прозорість та чесність — це основа будь-якого успішного проекту.",
      "pl":"Jego droga od programisty do dyrektora operacyjnego i inwestora jest przykładem ciągłego doskonalenia się i oddania swojej pracy. Bohdan wierzy, że przejrzystość i uczciwość to podstawa każdego udanego projektu.",
      "ru":"Его путь от программиста до операционного директора и инвестора является примером постоянного самосовершенствования и преданности своему делу. Богдан верит, что прозрачность и честность — это основа любого успешного проекта.",
      "en":"His path from programmer to COO and investor is an example of continuous self-improvement and dedication to his work. Bohdan believes that transparency and honesty are the foundation of any successful project."
    },
    'bogdan.moment4': {
      "ua":"У віці 20 років Богдан опинився в епіцентрі подій на сході України. Служба в розвідці (ГУР) змусила його швидко подорослішати, а участь у штурмі Луганської ТЕС та боях за аеропорт назавжди змінили його світогляд.",
      "pl":"W wieku 20 lat Bohdan znalazł się w samym centrum wydarzeń na wschodzie Ukrainy. Służba w wywiadzie (HUR) zmusiła go do szybkiego dorastania, a udział w szturmie na ługańską elektrownię cieplną i walkach o lotnisko na zawsze zmieniły jego światopogląd.",
      "ru":"В возрасте 20 лет Богдан оказался в эпицентре событий на востоке Украины. Служба в разведке (ГУР) заставила его быстро повзрослеть, а участие в штурме Луганской ТЭС и боях за аэропорт навсегда изменили его мировоззрение.",
      "en":"At the age of 20, Bohdan found himself in the epicenter of events in eastern Ukraine. Service in the intelligence (GUR) forced him to grow up quickly, and participation in the storming of the Luhansk thermal power plant and the battles for the airport changed his worldview forever."
    },
    'bogdan.sidebar_role': {"ua":"Операційний директор та Інвестор","pl":"Dyrektor operacyjny i Inwestor","ru":"Операционный директор и Инвестор","en":"COO & Investor"},
    'bogdan.social_label': {"ua":"Соціальні мережі","pl":"Media społecznościowe","ru":"Социальные сети","en":"Social media"},
    'bogdan.subtitle': {"ua":"Операційний директор та Інвестор","pl":"Dyrektor operacyjny i Inwestor","ru":"Операционный директор и Инвестор","en":"COO & Investor"},
    ...
    'company.meta_description': {"ua":"Офіційні реквізити, ліцензії та юридична інформація Rybezh Sp. z o.o. Гарантія легального працевлаштування та прозорості.","pl":"Oficjalne dane firmy, licencje i informacje prawne Rybezh Sp. z o.o. Gwarancja legalnego zatrudnienia i przejrzystości.","en":"Official company details, licenses, and legal information for Rybezh Sp. z o.o. Guarantee of legal employment and transparency.","ru":"Официальные реквизиты, лицензии и юридическая информация Rybezh Sp. z o.o. Гарантия легального трудоустройства и прозрачности."},
    'company.meta_title': {"ua":"Юридична інформація та реквізити — Rybezh","pl":"Dane firmy i informacje prawne — Rybezh","en":"Company Information & Legal Details — Rybezh","ru":"Юридическая информация и реквизиты — Rybezh"},
    'company.title': {"ua":"Реквізити","pl":"Dane firmy","en":"Company Information","ru":"Реквизиты"},
    ...
    'cv.exp.duties': {"ua":"Обов’язки","pl":"Obowiązki","ru":"Обязанности","en":"Duties"},
    ...
    'cv.skill.add': {"ua":"+ Додати","pl":"+ Dodaj","ru":"+ Добавить","en":"+ Add"},
    'emp.b1.text': {"ua":"Вашу вакансію побачать тисячі українців, які активно шукають роботу в Польщі","pl":"Twoją ofertę zobaczą tysiące Ukraińców aktywnie szukających pracy w Polsce","ru":"Вашу вакансию увидят тысячи украинцев, которые активно ищут работу в Польше","en":"Your vacancy will be seen by thousands of Ukrainians who are actively looking for work in Poland"},
    'emp.b1.title': {"ua":"🎯 Цільова аудиторія","pl":"🎯 Grupa docelowa","ru":"🎯 Целевая аудитория","en":"🎯 Target audience"},
    'emp.b2.text': {"ua":"Перші відгуки отримаєте протягом 24 годин після розміщення вакансії","pl":"Pierwsze zgłoszenia otrzymasz w ciągu 24 godzin od publikacji oferty","ru":"Первые отклики получите в течение 24 часов после размещения вакансии","en":"You will receive the first feedback within 24 hours after posting the vacancy"},
    'emp.b2.title': {"ua":"⚡ Швидкий результат","pl":"⚡ Szybki rezultat","ru":"⚡ Быстрый результат","en":"⚡ Quick result"},
    'emp.b3.text': {"ua":"Розміщення вакансій повністю безкоштовне. Без прихованих платежів та комісій","pl":"Publikacja ofert jest całkowicie bezpłatna. Bez ukrytych opłat i prowizji","ru":"Размещение вакансий полностью бесплатное. Без скрытых платежей и комиссий","en":"Posting vacancies is completely free. No hidden fees or commissions"},
    'emp.b3.title': {"ua":"💰 Безкоштовно","pl":"💰 Bezpłatnie","ru":"💰 Бесплатно","en":"💰 Free"},
    'emp.b4.text': {"ua":"Прямий зв’язок з кандидатами без агенцій та посередницьких комісій","pl":"Bezpośredni kontakt z kandydatami bez agencji i prowizji pośredników","ru":"Прямая связь с кандидатами без агентств и посреднических комиссий","en":"Direct contact with candidates without agencies and intermediary commissions"},
    'emp.b4.title': {"ua":"🤝 Без посередників","pl":"🤝 Bez pośredników","ru":"🤝 Без посредников","en":"🤝 Without intermediaries"},
    'emp.cta.telegram': {"ua":"💬 Написати в Telegram","pl":"💬 Napisz na Telegram","ru":"💬 Написать в Telegram","en":"💬 Write on Telegram"},
    'emp.cta.text': {"ua":"Зв'яжіться з нами напряму — допоможемо розмістити вакансію та знайти найкращих кандидатів","pl":"Skontaktuj się z nami — pomożemy opublikować ofertę i znaleźć najlepszych kandydatów","ru":"Свяжитесь с нами напрямую — поможем разместить вакансию и найти лучших кандидатов","en":"Contact us directly — we will help post the vacancy and find the best candidates."},
    'emp.cta.title': {"ua":"Маєте питання?","pl":"Masz pytania?","ru":"Есть вопросы?","en":"Ready to find employees?"},
    ...
    'emp.form.city': {"ua":"Місто *","pl":"Miasto *","ru":"Город *","en":"City *"},
    'emp.form.city_ph': {"ua":"— Оберіть місто —","pl":"— Wybierz miasto —","ru":"— Выберите город —","en":"— Choose a city —"},
    'emp.form.company': {"ua":"Назва компанії *","pl":"Nazwa firmy *","en":"Company Name","ru":"Название компании *"},
    'emp.form.company_ph': {"ua":"ТОВ \"Назва\"","pl":"Sp. z o.o. \"Nazwa\"","ru":"ООО \"Название\"","en":"Name LLC"},
    'emp.form.contract': {"ua":"Тип договору *","pl":"Typ umowy *","ru":"Тип договора *","en":"Type of contract *"},
    'emp.form.contract_ph': {"ua":"— Оберіть тип —","pl":"— Wybierz typ —","ru":"— Выберите тип —","en":"— Choose a type —"},
    'emp.form.desc': {"ua":"Опис вакансії *","pl":"Opis oferty *","ru":"Описание вакансии *","en":"Job description *"},
    'emp.form.desc_ph': {"ua":"Опишіть обов’язки, графік роботи, вимоги до кандидатів...","pl":"Opisz obowiązki, grafik pracy, wymagania wobec kandydatów...","ru":"Опишите обязанности, график работы, требования к кандидатам...","en":"Describe the duties, work schedule, requirements for candidates..."},
    ...
    'emp.form.housing': {"ua":"Житло для працівників","pl":"Zakwaterowanie dla pracowników","ru":"Жилье для работников","en":"Housing for employees"},
    'emp.form.housing_help': {"ua":"Допомагаємо знайти","pl":"Pomagamy znaleźć","ru":"Помогаем найти","en":"We help you find"},
    'emp.form.housing_no': {"ua":"Ні","pl":"Nie","ru":"Нет","en":"No"},
    'emp.form.housing_yes': {"ua":"Так, надаємо","pl":"Tak, zapewniamy","ru":"Да, предоставляем","en":"Yes, we provide"},
    'emp.form.other_city': {"ua":"Інше місто","pl":"Inne miasto","ru":"Другой город","en":"Another city"},
    'emp.form.other_type': {"ua":"Інший тип","pl":"Inny typ","ru":"Другой тип","en":"Another type"},
    ...
    'emp.form.plan': {"ua":"План","pl":"Plan","ru":"План","en":"Plan"},
    'emp.form.salary': {"ua":"Зарплата (PLN нетто/міс)","pl":"Wynagrodzenie (PLN netto/mies.)","ru":"Зарплата (PLN нетто/мес)","en":"Salary (PLN net/month)"},
    'emp.form.salary_from': {"ua":"від","pl":"od","ru":"от","en":"from"},
    'emp.form.salary_to': {"ua":"до","pl":"do","ru":"до","en":"to"},
    'emp.form.sub': {"ua":"Заповніть форму нижче — ми опублікуємо вашу вакансію протягом 24 годин","pl":"Wypełnij formularz — opublikujemy ofertę w ciągu 24 godzin","ru":"Заполните форму ниже — мы опубликуем вашу вакансию в течение 24 часов","en":"Fill out the form below and we'll post your job within 24 hours"},
    'emp.form.submit': {"ua":"🚀 Опублікувати вакансію","pl":"🚀 Opublikuj ofertę","en":"Send Request","ru":"🚀 Опубликовать вакансию"},
    'emp.form.title': {"ua":"📝 Розмістити вакансію","pl":"📝 Opublikuj ofertę","en":"Leave a request for staff","ru":"📝 Разместить вакансию"},
    ...
    'emp.form.workers': {"ua":"Кількість працівників","pl":"Liczba pracowników","ru":"Количество работников","en":"Number of employees"},
    ...
    'emp.meta_description': {"ua":"Розмістіть вакансію безкоштовно і знайдіть надійних українських працівників у Польщі. Без посередників, швидко та зручно.","pl":"Opublikuj ofertę za darmo i znajdź rzetelnych ukraińskich pracowników w Polsce. Bez pośredników, szybko i wygodnie.","en":"Looking for employees? Rybezh offers fast and high-quality staff recruitment for your business in Poland.","ru":"Разместите вакансию бесплатно и найдите надежных украинских работников в Польше. Без посредников, быстро и удобно."},
    'emp.meta_title': {"ua":"Для роботодавців — Rybezh | Опублікуйте вакансію","pl":"Dla pracodawców — Rybezh | Opublikuj ofertę","en":"For Employers — Rybezh | Recruitment in Poland","ru":"Для работодателей — Rybezh | Опубликуйте вакансию"},
    'emp.plan.basic.desc': {"ua":"Ідеально для швидкого закриття 1-2 вакансій","pl":"Idealne do szybkiego zamknięcia 1-2 wakatów","ru":"Идеально для быстрого закрытия 1-2 вакансий","en":"Perfect for quickly filling 1-2 vacancies"},
    'emp.plan.basic.f1': {"ua":"До 2 активних вакансій","pl":"Do 2 aktywnych ofert","ru":"До 2 активных вакансий","en":"Up to 2 active vacancies"},
    'emp.plan.basic.f2': {"ua":"Стандартне розміщення на 30 днів","pl":"Standardowa publikacja na 30 dni","ru":"Стандартное размещение на 30 дней","en":"Standard placement for 30 days"},
    'emp.plan.basic.f3': {"ua":"Доступ до відгуків","pl":"Dostęp do aplikacji","ru":"Доступ к откликам","en":"Access to applications"},
    'emp.plan.basic.f4': {"ua":"Базова підтримка (email)","pl":"Podstawowe wsparcie (email)","ru":"Базовая поддержка (email)","en":"Basic support (email)"},
    'emp.plan.basic.f5': {"ua":"-","pl":"-","ru":"-","en":"No branded page"},
    'emp.plan.basic.f6': {"ua":"-","pl":"-","ru":"-","en":"No access to CV database"},
    'emp.plan.basic.name': {"ua":"Базовий","pl":"Podstawowy","ru":"Базовый","en":"Basic"},
    'emp.plan.basic.period': {"ua":"/ за публікацію","pl":"/ za publikację","ru":"/ за публикацию","en":"/ per publication"},
    'emp.plan.biz.desc': {"ua":"Для компаній з постійною потребою в людях","pl":"Dla firm ze stałym zapotrzebowaniem na pracowników","ru":"Для компаний с постоянной потребностью в людях","en":"For companies with a constant need for staff"},
    'emp.plan.biz.f1': {"ua":"Необмежена кількість вакансій","pl":"Nielimitowana liczba ofert","ru":"Неограниченное количество вакансий","en":"Unlimited vacancies"},
    'emp.plan.biz.f2': {"ua":"Автоматичне підняття 1 раз на тиждень","pl":"Automatyczne podbijanie raz w tygodniu","ru":"Автоматическое поднятие 1 раз в неделю","en":"Automatic bump once a week"},
    'emp.plan.biz.f3': {"ua":"Преміум підтримка (Telegram)","pl":"Wsparcie premium (Telegram)","ru":"Премиум поддержка (Telegram)","en":"Premium support (Telegram)"},
    'emp.plan.biz.f4': {"ua":"Персональний менеджер","pl":"Osobisty opiekun","ru":"Персональный менеджер","en":"Personal manager"},
    'emp.plan.biz.f5': {"ua":"Брендована сторінка компанії","pl":"Obrandowana strona firmy","ru":"Брендированная страница компании","en":"Branded company page"},
    'emp.plan.biz.f6': {"ua":"Доступ до бази резюме","pl":"Dostęp do bazy CV","ru":"Доступ к базе резюме","en":"Access to CV database"},
    'emp.plan.biz.name': {"ua":"Бізнес","pl":"Biznes","ru":"Бизнес","en":"Business"},
    'emp.plan.biz.period': {"ua":"/ місяць","pl":"/ miesiąc","ru":"/ месяц","en":"/ month"},
    'emp.plan.cta.biz': {"ua":"Зв'язатися","pl":"Skontaktuj się","ru":"Связаться","en":"Contact Us"},
    'emp.plan.cta.free': {"ua":"Безкоштовно","pl":"Za darmo","ru":"Бесплатно","en":"Free"},
    'emp.plan.cta.pro': {"ua":"Обрати План Pro","pl":"Wybierz Plan Pro","ru":"Выбрать План Pro","en":"Choose Pro Plan"},
    'emp.plan.pro.badge': {"ua":"Популярний","pl":"Popularny","ru":"Популярный","en":"Popular"},
    'emp.plan.pro.desc': {"ua":"Оптимально для агенцій та прямого найму","pl":"Optymalne dla agencji i rekrutacji bezpośredniej","ru":"Оптимально для агентств и прямого найма","en":"Optimal for agencies and direct hiring"},
    'emp.plan.pro.f1': {"ua":"До 10 активних вакансій","pl":"Do 10 aktywnych ofert","ru":"До 10 активных вакансий","en":"Up to 10 active vacancies"},
    'emp.plan.pro.f2': {"ua":"Пріоритетне розміщення в пошуку","pl":"Priorytetowe pozycjonowanie w wyszukiwarce","ru":"Приоритетное размещение в поиске","en":"Priority placement in search"},
    'emp.plan.pro.f3': {"ua":"Розсилка в Telegram канал","pl":"Wysyłka na kanał Telegram","ru":"Рассылка в Telegram канал","en":"Mailing to Telegram channel"},
    'emp.plan.pro.f4': {"ua":"Пріоритетна підтримка","pl":"Wsparcie priorytetowe","ru":"Приоритетная поддержка","en":"Priority support"},
    'emp.plan.pro.f5': {"ua":"-","pl":"-","ru":"-","en":"No branded page"},
    'emp.plan.pro.f6': {"ua":"-","pl":"-","ru":"-","en":"No access to CV database"},
    'emp.plan.pro.name': {"ua":"Професійний","pl":"Profesjonalny","ru":"Профессиональный","en":"Professional"},
    'emp.plan.pro.period': {"ua":"/ місяць","pl":"/ miesiąc","ru":"/ месяц","en":"/ month"},
    'emp.pricing.lead': {"ua":"Зрозумілі та прозорі тарифи для компаній будь-якого розміру","pl":"Jasne i przejrzyste plany dla firm każdej wielkości","ru":"Понятные и прозрачные тарифы для компаний любого размера","en":"Clear and transparent pricing for companies of any size"},
    'emp.pricing.title': {"ua":"Тарифи на розміщення","pl":"Cennik","ru":"Тарифы на размещение","en":"Pricing"},
    'emp.proof.text': {"ua":"Кожна вакансія та компанія отримує Rybezh Proof на основі реальних відгуків кандидатів. Це допомагає роботодавцям формувати довіру, а кандидатам — швидше приймати рішення.","pl":"Każda oferta i firma otrzymuje Rybezh Proof na podstawie realnych opinii kandydatów. To buduje zaufanie do pracodawcy i pomaga kandydatom szybciej podejmować decyzję.","ru":"Каждая вакансия и компания получает Rybezh Proof на основе реальных отзывов кандидатов. Это помогает работодателям формировать доверие, а кандидатам — быстрее принимать решения.","en":"Each vacancy and company receives Rybezh Proof based on real candidate reviews. This helps employers build trust and candidates make decisions faster."},
    ...
    'emp.stat1': {"ua":"Активних кандидатів","pl":"Aktywnych kandydatów","ru":"Активных кандидатов","en":"Active candidates"},
    'emp.stat2': {"ua":"Вакансій розміщено","pl":"Opublikowanych ofert","ru":"Вакансий размещено","en":"Vacancies are posted"},
    'emp.stat3': {"ua":"Міст покриття","pl":"Miast w zasięgu","ru":"Городов покрытия","en":"Coverage cities"},
    'emp.stat4': {"ua":"Час відповіді","pl":"Czas odpowiedzi","ru":"Время ответа","en":"Response time"},
    'emp.subtitle': {"ua":"Розмістіть вакансію безкоштовно та отримайте відгуки від мотивованих кандидатів протягом 24 годин","pl":"Opublikuj ofertę za darmo i otrzymaj zgłoszenia od zmotywowanych kandydatów w ciągu 24 godzin","en":"Fast and reliable staff recruitment for your business.","ru":"Разместите вакансию бесплатно и получите отклики от мотивированных кандидатов в течение 24 часов"},
    'emp.title': {"ua":"Знайдіть надійних працівників з України","pl":"Znajdź rzetelnych pracowników z Ukrainy","en":"For Employers","ru":"Найдите надежных работников из Украины"},
    ...
    'filters.reset': {"ua":"Скинути","pl":"Resetuj","ru":"Сбросить","en":"Reset"},
    ...
    'footer.tagline': {"ua":"Робота в Польщі для українців","pl":"Praca w Polsce dla Ukraińców","ru":"Работа в Польше для украинцев","en":"Work in Poland for Ukrainians"},
    ...
    'hero.lead': {"ua":"Актуальні вакансії в різних сферах по всій Польщі. Легальні умови та підтримка.","pl":"Aktualne oferty w różnych branżach w całej Polsce. Legalne warunki i wsparcie.","ru":"Актуальные вакансии в разных сферах по всей Польше. Легальные условия и поддержка.","en":"Current vacancies in various fields throughout Poland. Legal conditions and support."},
    'hero.title': {"ua":"Знайдіть роботу в Польщі","pl":"Znajdź pracę w Polsce","ru":"Найдите работу в Польше","en":"Find a job in Poland"},
    'home.calc.city_count': {"ua":"вакансій","pl":"ofert","ru":"вакансий","en":"vacancies"},
    'home.calc.contract': {"ua":"Тип договору","pl":"Typ umowy","ru":"Тип договора","en":"Contract type"},
    'home.calc.full': {"ua":"Розширений калькулятор з витратами →","pl":"Rozszerzony kalkulator z kosztami →","ru":"Расширенный калькулятор с расходами →","en":"Extended calculator with expenses →"},
    'home.calc.gross': {"ua":"Brutto (до податків)","pl":"Brutto (przed podatkami)","ru":"Brutto (до налогов)","en":"Gross (before taxes)"},
    'home.calc.lead': {"ua":"Дізнайтеся реальний дохід «на руки» з урахуванням податків та витрат","pl":"Poznaj realny dochód „na rękę\" z uwzględnieniem podatków i kosztów","ru":"Узнайте реальный доход «на руки» с учетом налогов и расходов","en":"Find out the real \"take-home\" income considering taxes and expenses"},
    'home.calc.net': {"ua":"Netto (на руки)","pl":"Netto (na rękę)","ru":"Netto (на руки)","en":"Net (take-home)"},
    'home.calc.note': {"ua":"*приблизний розрахунок за 2025 рік","pl":"*przybliżone obliczenie za 2025 rok","ru":"*приблизительный расчет за 2025 год","en":"*approximate calculation for 2025"},
    'home.calc.tax': {"ua":"Податки та внески","pl":"Podatki i składki","ru":"Налоги и взносы","en":"Taxes and contributions"},
    ...
    'home.faq.cta': {"ua":"Всі питання","pl":"Wszystkie pytania","ru":"Все вопросы","en":"All Questions"},
    'home.faq.lead': {"ua":"Відповіді на найпоширеніші запитання кандидатів","pl":"Odpowiedzi na najczęstsze pytania kandydatów","ru":"Ответы на самые частые вопросы кандидатов","en":"Answers to the most common questions from candidates"},
    'home.faq.title': {"ua":"Поширені запитання","pl":"Często zadawane pytania","ru":"Частые вопросы","en":"Frequently Asked Questions"},
    ...
    'home.stats.note': {"ua":"*Оцінки за внутрішнім опитуванням кандидатів","pl":"*Oceny z wewnętrznej ankiety kandydatów","en":"*Ratings based on internal candidate surveys","ru":"*Оценки по внутреннему опросу кандидатов"},
    ...
    'home.stats.title': {"ua":"📊 Статистика успіху","pl":"📊 Statystyki sukcesu","en":"📊 Success Statistics","ru":"📊 Статистика успеха"},
    'home.team.cta': {"ua":"Докладніше про команду","pl":"Więcej o zespole","ru":"Подробнее о команде","en":"More about the team"},
    'home.team.lead': {"ua":"Експерти, які допомагають вам на кожному етапі","pl":"Eksperci, którzy pomagają Ci na każdym etapie","ru":"Эксперты, которые помогают вам на каждом этапе","en":"Experts who help you at every stage"},
    'home.team.title': {"ua":"Наша команда","pl":"Nasz zespół","ru":"Наша команда","en":"Our Team"},
    'home.testimonials.note': {"ua":"*Досвід кандидатів може відрізнятися залежно від міста та роботодавця","pl":"*Doświadczenia kandydatów mogą się różnić w zależności od miasta i pracodawcy","en":"*Candidate experiences may vary by city and employer","ru":"*Опыт кандидатов может отличаться в зависимости от города и работодателя"},
    ...
    'home.testimonials.t4.name': {"ua":"Андрій Т.","pl":"Andrzej T.","ru":"Андрей Т.","en":"Andrii T."},
    'home.testimonials.t4.quote': {"ua":"Працюю на заводі під Познанню вже 8 місяців. Зарплату платять вчасно, є медична страховка. Rybezh допоміг швидко знайти саме те, що шукав.","pl":"Pracuję w fabryce pod Poznaniem już 8 miesięcy. Wypłaty są na czas, jest opieka medyczna. Rybezh pomógł mi szybko znaleźć dokładnie to, czego szukałem.","ru":"Работаю на заводе под Познанью уже 8 месяцев. Зарплату платят вовремя, есть медицинская страховка. Rybezh помог быстро найти именно то, что искал.","en":"I have been working at a factory near Poznań for 8 months. The salary is paid on time, there is medical insurance. Rybezh helped me quickly find exactly what I was looking for."},
    'home.testimonials.t4.role': {"ua":"Оператор лінії, 8 міс. досвіду","pl":"Operator linii, 8 mies. doświadczenia","ru":"Оператор линии, 8 мес. опыта","en":"Line operator, 8 months of experience"},
    'home.testimonials.t5.name': {"ua":"Оксана М.","pl":"Oksana M.","ru":"Оксана М.","en":"Oksana M."},
    'home.testimonials.t5.quote': {"ua":"Переїхала з Харкова і боялася шахрайства. Rybezh Proof допоміг перевірити компанію перед виїздом. Тепер працюю в готелі і все чудово!","pl":"Przeprowadziłam się z Charkowa i bałam się oszustw. Rybezh Proof pomógł sprawdzić firmę przed wyjazdem. Teraz pracuję w hotelu i wszystko jest świetnie!","ru":"Переехала из Харькова и боялась мошенничества. Rybezh Proof помог проверить компанию перед выездом. Теперь работаю в отеле и все отлично!","en":"I moved from Kharkiv and was afraid of scams. Rybezh Proof helped verify the company before leaving. Now I work in a hotel and everything is great!"},
    'home.testimonials.t5.role': {"ua":"Покоївка готелю, 5 міс. досвіду","pl":"Pokojówka, 5 mies. doświadczenia","ru":"Горничная отеля, 5 мес. опыта","en":"Hotel maid, 5 months of experience"},
    'home.testimonials.t6.name': {"ua":"Віталій С.","pl":"Witalij S.","ru":"Виталий С.","en":"Vitalii S."},
    'home.testimonials.t6.quote': {"ua":"Калькулятор зарплати дуже допоміг зрозуміти, скільки буде на руки. Без цього легко помилитися з очікуваннями.","pl":"Kalkulator wynagrodzeń bardzo pomógł zrozumieć, ile będzie na rękę. Bez tego łatwo pomylić się w oczekiwaniach.","ru":"Калькулятор зарплаты очень помог понять, сколько будет на руки. Без этого легко ошибиться с ожиданиями.","en":"The salary calculator helped a lot to understand how much I would get in hand. Without it, it's easy to make a mistake with expectations."},
    'home.testimonials.t6.role': {"ua":"Електромонтажник, 4 міс. досвіду","pl":"Elektromonter, 4 mies. doświadczenia","ru":"Электромонтажник, 4 мес. опыта","en":"Electrician, 4 months of experience"},
    'home.testimonials.t7.name': {"ua":"Наталія Д.","pl":"Natalia D.","ru":"Наталья Д.","en":"Nataliia D."},
    'home.testimonials.t7.quote': {"ua":"Я мама двох дітей і знайшла роботу з гнучким графіком. Дуже дякую за підтримку і допомогу з документами!","pl":"Jestem mamą dwójki dzieci i znalazłam pracę z elastycznym grafikiem. Bardzo dziękuję za wsparcie i pomoc z dokumentami!","ru":"Я мама двоих детей и нашла работу с гибким графиком. Большое спасибо за поддержку и помощь с документами!","en":"I am a mother of two children and found a job with a flexible schedule. Thank you very much for the support and help with documents!"},
    'home.testimonials.t7.role': {"ua":"Прибиральниця, 7 міс. досвіду","pl":"Sprzątaczka, 7 mies. doświadczenia","ru":"Уборщица, 7 мес. опыта","en":"Cleaner, 7 months of experience"},
    ...
    'home.trust.cities': {"ua":"20+","pl":"20+","ru":"20+","en":"20+"},
    'home.trust.cities_label': {"ua":"міст по всій Польщі","pl":"miast w całej Polsce","ru":"городов по всей Польше","en":"cities across Poland"},
    'home.trust.factcheck': {"ua":"100%","pl":"100%","ru":"100%","en":"100%"},
    'home.trust.factcheck_label': {"ua":"перевірені вакансії","pl":"sprawdzone oferty","ru":"проверенные вакансии","en":"verified vacancies"},
    'home.trust.support': {"ua":"24/7","pl":"24/7","ru":"24/7","en":"24/7"},
    'home.trust.support_label': {"ua":"підтримка в Telegram","pl":"wsparcie na Telegramie","ru":"поддержка в Telegram","en":"support on Telegram"},
    'home.trust.users': {"ua":"5 000+","pl":"5 000+","ru":"5 000+","en":"5 000+"},
    'home.trust.users_label': {"ua":"українців знайшли роботу","pl":"Ukraińców znalazło pracę","ru":"украинцев нашли работу","en":"Ukrainians found work"},
    'home.trust.verified': {"ua":"100%","pl":"100%","ru":"100%","en":"100%"},
    'home.trust.verified_label': {"ua":"перевірені вакансії","pl":"sprawdzone oferty","ru":"проверенные вакансии","en":"verified vacancies"},
    ...
    'job.article.cta_title': {"ua":"Готові почати?","pl":"Gotowy, by zacząć?","ru":"Готовы начать?","en":"Ready to start?"},
    'job.article.why': {"ua":"💡 Чому саме ми?","pl":"💡 Dlaczego my?","ru":"💡 Почему именно мы?","en":"💡 Why us?"},
    ...
    'label.resume': {"ua":"Резюме","pl":"CV","ru":"Резюме","en":"Resume"},
    ...
    'nav.tool.swipe': {"ua":"🔥 Свайп Вакансій","pl":"🔥 Swipe Ofert","ru":"🔥 Свайп Вакансий","en":"🔥 Job Swipe"},
    'nav.tool.swipe.short': {"ua":"🔥 Свайп Вакансій","pl":"🔥 Swipe Ofert","ru":"🔥 Свайп Вакансий","en":"🔥 Job Swipe"},
    ...
    'placeholder.exp': {"ua":"Наприклад: 2 роки у сфері складу","pl":"Na przykład: 2 lata w logistyce","en":"For example: 2 years in logistics","ru":"Например: 2 года в сфере склада"},
    'placeholder.message': {"ua":"Додайте деталі","pl":"Dodaj szczegóły","en":"Add details","ru":"Добавьте детали"},
    'placeholder.name': {"ua":"Петро","pl":"Piotr","en":"Peter","ru":"Пётр"},
    'privacy.meta_description': {"ua":"Політика конфіденційності Rybezh. Дізнайтеся, як ми обробляємо ваші дані та захищаємо вашу приватність.","pl":"Polityka prywatności Rybezh. Dowiedz się, jak przetwarzamy Twoje dane i chronimy Twoją prywatność.","en":"Privacy policy and personal data processing rules at Rybezh.","ru":"Политика конфиденциальности Rybezh. Узнайте, как мы обрабатываем ваши данные и защищаем вашу приватность."},
    ...
    'swipe.apply_all': {"ua":"Подати заявку на вибрані","pl":"Aplikuj na wybrane","ru":"Подать заявку на выбранные","en":"Apply to selected"},
    'swipe.cart_empty': {"ua":"Ваш кошик порожній. Свайпайте вправо, щоб додати вакансії.","pl":"Twój koszyk jest pusty. Przesuń w prawo, aby dodać oferty.","ru":"Ваша корзина пуста. Свайпайте вправо, чтобы добавить вакансии.","en":"Your cart is empty. Swipe right to add jobs."},
    'swipe.cart_title': {"ua":"Збережені","pl":"Zapisane","ru":"Сохраненные","en":"Saved"},
    'swipe.done_subtitle': {"ua":"Зачекайте на нові або змініть фільтри (якщо є).","pl":"Poczekaj na nowe lub zmień filtry (jeśli są).","ru":"Подождите новые или измените фильтры (если есть).","en":"Wait for new ones or change filters (if any)."},
    'swipe.done_title': {"ua":"Ви переглянули всі вакансії!","pl":"Przejrzałeś wszystkie oferty!","ru":"Вы просмотрели все вакансии!","en":"You have reviewed all jobs!"},
    'swipe.reload': {"ua":"Почати спочатку","pl":"Zacznij od nowa","ru":"Начать сначала","en":"Start over"},
    'swipe.subtitle': {"ua":"Свайпай вправо, щоб зберегти. Вліво — щоб пропустити.","pl":"Przesuń w prawo, aby zapisać. W lewo — aby pominąć.","ru":"Свайпай вправо, чтобы сохранить. Влево — чтобы пропустить.","en":"Swipe right to save. Left to skip."},
    'swipe.title': {"ua":"Свайп Вакансій","pl":"Swipe Ofert","ru":"Свайп Вакансий","en":"Job Swipe"},
    ...
    'respond.intro': {"ua":"Залиште свої контакти, і ми зв'яжемося з вами найближчим часом для обговорення деталей.","pl":"Zostaw swoje dane kontaktowe, a my skontaktujemy się z Tobą wkrótce, aby omówić szczegóły.","ru":"Оставьте свои контакты, и мы свяжемся с вами в ближайшее время для обсуждения деталей.","en":"Leave your contact details and we will contact you shortly to discuss the details."},
    'respond.title': {"ua":"Відгук на вакансію","pl":"Aplikacja na stanowisko","ru":"Отклик на вакансию","en":"Job Application"},
    ...
    'scroll.top': {"ua":"Вгору","pl":"Do góry","ru":"Наверх","en":"Top"},
    ...
    'search.sr': {"ua":"Пошук","pl":"Szukaj","en":"Search","ru":"Поиск"},
