...
(function() {
  ...
  const translations = {
    ...
    'home.stats.candidates.line1': { ua: 'Кандидатів скористалось', pl: 'Kandydatów skorzystało' },
    'home.stats.candidates.line2': { ua: 'нашою платформою', pl: 'z naszej platformy' },
    ...
    'home.testimonials.t2.role': { ua: 'Працівник складу, 3 міс. досвіду', pl: 'Pracownik magazynu, 3 mies. doświadczenia' },
