...
(function() {
  ...
  const translations = {
    ...
    'human.home.title': { ua: 'По‑людськи про пошук роботи', pl: 'Prosto i uczciwie o pracy' },
    'human.home.lead': { ua: 'Ми не обіцяємо «золоті гори». Наша задача — дати вам зрозумілі умови, реальні кроки і підтримку, якщо щось незрозуміло.', pl: 'Nie obiecujemy „złotych gór”. Chcemy dać jasne warunki, konkretne kroki i wsparcie, gdy coś jest niejasne.' },
    'human.home.i1.title': { ua: 'Що ви знайдете тут', pl: 'Co tu znajdziesz' },
    'human.home.i1.li1': { ua: 'вакансії з описом задач простими словами', pl: 'oferty opisane prostym, zrozumiałym językiem' },
    'human.home.i1.li2': { ua: 'пояснення по документах і старту роботи', pl: 'wyjaśnienia dotyczące dokumentów i rozpoczęcia pracy' },
    'human.home.i1.li3': { ua: 'контакт, щоб уточнити нюанси до виїзду', pl: 'kontakt, żeby wyjaśnić szczegóły przed wyjazdem' },
    'human.home.i2.title': { ua: 'Як ми радимо обирати', pl: 'Jak radzimy wybierać' },
