...
(function() {
  ...
  const translations = {
    ...
    'bogdan.subtitle': { ua: 'Інвестор, Операційний директор', pl: 'Inwestor, Dyrektor operacyjny', ru: 'Инвестор, Операционный директор', en: 'Investor, Chief Operating Officer' },
    ...
    'bogdan.sidebar_role': { ua: 'Інвестор, Операційний директор', pl: 'Inwestor, Dyrektor operacyjny', ru: 'Инвестор, Операционный директор', en: 'Investor, Chief Operating Officer' },
