...
(function() {
  ...
  const translations = {
    ...
    'home.stats.title': { ua: '📊 Статистика успіху', pl: '📊 Statystyki sukcesu' , en: '📊 Success Statistics'},
    'home.stats.candidates.line1': { ua: 'Кандидатів скористалось', pl: 'Kandydatów skorzystało' , en: 'Candidates used'},
    'home.stats.candidates.line2': { ua: 'нашою платформою', pl: 'z naszej platformy' , en: 'our platform'},
    'home.stats.partners.line1': { ua: 'Партнерських компаній', pl: 'Firm partnerskich' , en: 'Partner companies'},
    'home.stats.partners.line2': { ua: 'у Польщі', pl: 'w Polsce' , en: 'in Poland'},
    'home.stats.cities.line1': { ua: 'Міст із вакансіями', pl: 'Miast z ofertami' , en: 'Cities with jobs'},
    'home.stats.cities.line2': { ua: 'від Варшави до Гданська', pl: 'od Warszawy po Gdańsk' , en: 'from Warsaw to Gdansk'},
    'home.stats.rating.line1': { ua: 'Рейтинг задоволення', pl: 'Ocena zadowolenia' , en: 'Satisfaction rating'},
    'home.stats.rating.line2': { ua: 'від кандидатів', pl: 'od kandydatów' , en: 'from candidates'},
    'home.stats.note': { ua: '*Оцінки за внутрішнім опитуванням кандидатів', pl: '*Oceny z wewnętrznej ankiety kandydatów' , en: '*Ratings based on internal candidate surveys'},
    'home.testimonials.title': { ua: '💬 Що кажуть кандидати', pl: '💬 Co mówią kandydaci' , en: '💬 What Candidates Say'},
    'home.testimonials.t1.quote': { ua: '"Після консультації отримав чіткий план кроків і зрозумів, на що звертати увагу."', pl: '"Po konsultacji dostałem jasny plan kroków i wiedziałem, na co zwracać uwagę."' , en: '"After the consultation, I received a clear step-by-step plan and knew exactly what to look out for."'},
    'home.testimonials.t1.name': { ua: 'Ігор К., Варшава', pl: 'Igor K., Warszawa' , en: 'Igor K., Warsaw'},
    'home.testimonials.t1.role': { ua: 'Пакувальник, 6 міс. досвіду', pl: 'Pakowacz, 6 mies. doświadczenia' , en: 'Packer, 6 mos. experience'},
    'home.testimonials.t2.quote': { ua: '"Умови виявилися близькими до опису, але деякі деталі довелося уточнити."', pl: '"Warunki były zbliżone do opisu, ale część szczegółów musiałem doprecyzować."' , en: '"The conditions were close to the description, but I had to clarify some details first."'},
    'home.testimonials.t2.name': { ua: 'Максим В., Краків', pl: 'Maksym W., Kraków' , en: 'Maksym W., Krakow'},
    'home.testimonials.t2.role': { ua: 'Працівник складу, 3 міс. досвіду', pl: 'Pracownik magazynu, 3 mies. doświadczenia' , en: 'Warehouse Worker, 3 mos. experience'},
    'home.testimonials.t3.quote': { ua: '"Графік підійшов, але спочатку було складно з логістикою — потім адаптувався."', pl: '"Grafik pasował, ale na początku logistyka była trudna — potem się dostosowałem."' , en: '"The schedule was a good fit, though logistics were tough at first — I adapted later."'},
    'home.testimonials.t3.name': { ua: 'Софія Л., Вроцлав', pl: 'Sofia L., Wrocław' , en: 'Sofia L., Wroclaw'},
    'home.testimonials.t3.role': { ua: 'Студентка, 4 міс. досвіду', pl: 'Studentka, 4 mies. doświadczenia' , en: 'Student, 4 mos. experience'},
    'home.testimonials.note': { ua: '*Досвід кандидатів може відрізнятися залежно від міста та роботодавця', pl: '*Doświadczenia kandydatów mogą się różnić w zależności od miasta i pracodawcy' , en: '*Candidate experiences may vary by city and employer'},
    ...
    'search.sr': { ua: 'Пошук', pl: 'Szukaj' , en: 'Search'},
    ...
    'placeholder.name': { ua: 'Петро', pl: 'Piotr' , en: 'Peter'},
    'placeholder.contact': { ua: '+48 123 456 789 або contacts@rybezh.site', pl: '+48 123 456 789 lub contacts@rybezh.site' , en: '+48 123 456 789 or contacts@rybezh.site'},
    'placeholder.city': { ua: 'Варшава, Краків...', pl: 'Warszawa, Kraków...' , en: 'Warsaw, Krakow...'},
    'placeholder.message': { ua: 'Додайте деталі', pl: 'Dodaj szczegóły' , en: 'Add details'},
    'placeholder.exp': { ua: 'Наприклад: 2 роки у сфері складу', pl: 'Na przykład: 2 lata w logistyce' , en: 'For example: 2 years in logistics'},
    ...
    'about.mission_text': { ua: 'Ми прагнемо зробити процес працевлаштування за кордоном простим, прозорим та безпечним. Ми надаємо повний супровід: від першої консультації до підписання договору та виходу на першу зміну.', pl: 'Dążymy do tego, aby proces zatrudnienia za granicą był prosty, przejrzysty i bezpieczny. Zapewniamy pełne wsparcie: od pierwszej konsultacji po podpisanie umowy i pierwszą zmianę.' , en: 'To provide safe, legal, and comfortable employment for Ukrainians in Poland by connecting reliable employers with motivated candidates.'},
    ...
    'about.step1': { ua: '1️⃣ Консультація (Безкоштовно)', pl: '1️⃣ Konsultacja (Bezpłatnie)' , en: '1️⃣ Application & Consultation'},
    'about.step2': { ua: '2️⃣ Підбір вакансії', pl: '2️⃣ Dobór oferty pracy' , en: '2️⃣ Job Matching'},
    'about.step3': { ua: '3️⃣ Оформлення документів', pl: '3️⃣ Formalizacja dokumentów' , en: '3️⃣ Paperwork'},
    'about.step4': { ua: '4️⃣ Початок роботи', pl: '4️⃣ Rozpoczęcie pracy' , en: '4️⃣ Moving & Adaptation'},
    ...
    'privacy.meta_title': { ua: 'Політика конфіденційності — Rybezh', pl: 'Polityka prywatności — Rybezh' , en: 'Privacy Policy — Rybezh'},
    'privacy.meta_description': { ua: 'Політика конфіденційності Rybezh. Дізнайтеся, як ми обробляємо ваші дані та захищаємо вашу приватність.', pl: 'Polityka prywatności Rybezh. Dowiedz się, jak przetwarzamy Twoje dane i chronimy Twoją prywatność.' , en: 'Privacy policy and personal data processing rules at Rybezh.'},
    'company.meta_title': { ua: 'Реквізити — Rybezh', pl: 'Dane firmy — Rybezh' , en: 'Company Information — Rybezh'},
    'company.meta_description': { ua: 'Реквізити власника сайту, юридична інформація та контактні дані.', pl: 'Dane właściciela serwisu, informacje prawne i kontakt.' , en: 'Legal details and information about the company Rybezh.'},
    'company.title': { ua: 'Реквізити', pl: 'Dane firmy' , en: 'Company Information'},
    'privacy.title': { ua: 'Політика конфіденційності', pl: 'Polityka prywatności' , en: 'Privacy Policy'},
    ...
    // For Employers page
    'nav.employers': { ua: 'Для роботодавців', pl: 'Dla pracodawców' , en: 'For Employers'},
    'emp.meta_title': { ua: 'Для роботодавців — Rybezh | Опублікуйте вакансію', pl: 'Dla pracodawców — Rybezh | Opublikuj ofertę' , en: 'For Employers — Rybezh | Recruitment in Poland'},
    'emp.meta_description': { ua: 'Розмістіть вакансію безкоштовно і знайдіть надійних українських працівників у Польщі. Без посередників, швидко та зручно.', pl: 'Opublikuj ofertę za darmo i znajdź rzetelnych ukraińskich pracowników w Polsce. Bez pośredników, szybko i wygodnie.' , en: 'Looking for employees? Rybezh offers fast and high-quality staff recruitment for your business in Poland.'},
    'emp.title': { ua: 'Знайдіть надійних працівників з України', pl: 'Znajdź rzetelnych pracowników z Ukrainy' , en: 'For Employers'},
    'emp.subtitle': { ua: 'Розмістіть вакансію безкоштовно та отримайте відгуки від мотивованих кандидатів протягом 24 годин', pl: 'Opublikuj ofertę za darmo i otrzymaj zgłoszenia od zmotywowanych kandydatów w ciągu 24 godzin' , en: 'Fast and reliable staff recruitment for your business.'},
    'emp.b1.title': { ua: '🎯 Цільова аудиторія', pl: '🎯 Grupa docelowa' },
    'emp.b1.text': { ua: 'Вашу вакансію побачать тисячі українців, які активно шукають роботу в Польщі', pl: 'Twoją ofertę zobaczą tysiące Ukraińców aktywnie szukających pracy w Polsce' },
    ...
    'emp.form.title': { ua: '📝 Розмістити вакансію', pl: '📝 Opublikuj ofertę' , en: 'Leave a request for staff'},
    ...
    'emp.form.company': { ua: 'Назва компанії *', pl: 'Nazwa firmy *' , en: 'Company Name'},
    ...
    'emp.form.phone': { ua: 'Телефон / Telegram', pl: 'Telefon / Telegram' , en: 'Phone'},
    ...
    'emp.form.submit': { ua: '🚀 Опублікувати вакансію', pl: '🚀 Opublikuj ofertę' , en: 'Send Request'},
    ...
    'cv.meta_title': { ua: 'Генератор CV для роботи в Польщі — Rybezh', pl: 'Generator CV do pracy w Polsce — Rybezh' , en: 'CV Generator — Rybezh'},
    'cv.meta_description': { ua: 'Створіть професійне резюме за 4 кроки з RODO-застереженням та супровідним листом.', pl: 'Stwórz profesjonalne CV w 4 krokach z klauzulą RODO i listem motywacyjnym.' , en: 'Create a professional CV for employers in Poland for free online.'},
    ...
    // Terms page
    'terms.meta_title': { ua: 'Умови користування — Rybezh', pl: 'Regulamin — Rybezh' , en: 'Terms of Use — Rybezh'},
    'terms.meta_description': { ua: 'Умови користування сайтом Rybezh: правила, відповідальність, обробка запитів.', pl: 'Regulamin korzystania z serwisu Rybezh: zasady, odpowiedzialność, obsługa zgłoszeń.' , en: 'Terms of use for the Rybezh website and services.'},
    'terms.title': { ua: 'Умови користування', pl: 'Regulamin' , en: 'Terms of Use'},
