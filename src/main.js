...
(function() {
  ...
  const translations = {
    ...
    'rent.bike.desc': { ua: 'Міцні міські велосипеди. Надійні гальма, посилена рама. Ідеально для старту в доставці (від 150 zł/тиждень).', pl: 'Mocne rowery miejskie. Niezawodne hamulce, wzmocniona rama. Idealne na start w dostawach (od 150 zł/tydzień).', ru: 'Крепкие городские велосипеды. Надежные тормоза, усиленная рама. Идеально для старта в доставке (от 150 zł/неделя).', en: 'Sturdy city bikes. Reliable brakes, reinforced frame. Ideal for starting in delivery (from 150 zł/week).'},
    'rent.scooter': { ua: 'Скутер Lifan', pl: 'Skuter Lifan', ru: 'Скутер Lifan', en: 'Scooter Lifan'},
    'rent.scooter.desc': { ua: 'Скутер 50 куб.см з реальною витратою 2-2.5 л/100 км. Ідеальний маневрений варіант для Glovo/Wolt. Можна їздити з правами категорії B.', pl: 'Skuter 50 cm3 o realnym spalaniu 2-2.5 l/100 km. Idealna zwrotna opcja dla Glovo/Wolt. Można jeździć z kategorią B.', ru: 'Скутер 50 куб.см с реальным расходом 2-2.5 л/100 км. Идеальный маневренный вариант для Glovo/Wolt. Можно ездить с категорией B.', en: '50cc scooter with real consumption of 2-2.5 l/100 km. Ideal maneuverable option for Glovo/Wolt. Can be driven with category B.'},
    'rent.moto': { ua: 'Мотоцикл 125cc (Yamaha/Honda)', pl: 'Motocykl 125cc (Yamaha/Honda)', ru: 'Мотоцикл 125cc (Yamaha/Honda)', en: 'Motorcycle 125cc (Yamaha/Honda)'},
    'rent.moto.desc': { ua: 'Надійна техніка 125 куб.см для тих, хто заробляє на швидкості. Витрата 2.5-3 л/100 км. Потрібні права B (від 3 років) або A.', pl: 'Niezawodny sprzęt 125 cm3 dla tych, którzy zarabiają na szybkości. Spalanie 2.5-3 l/100 km. Wymagane kat. B (min. 3 lata) lub A.', ru: 'Надежная техника 125 куб.см для тех, кто зарабатывает на скорости. Расход 2.5-3 л/100 км. Нужны права B (от 3 лет) или A.', en: 'Reliable 125cc equipment for those who earn on speed. Consumption 2.5-3 l/100 km. B (from 3 years) or A license required.'},
    'rent.car': { ua: 'Економне авто на газу (LPG)', pl: 'Ekonomiczne auto na gaz (LPG)', ru: 'Экономное авто на газу (LPG)', en: 'Economical LPG car'},
    'rent.car.desc': { ua: 'Авто B-класу (напр. Skoda Fabia) з ГБО. Реальна витрата газу 7-8 л/100 км. Повністю підготовлене для роботи в таксі (Bolt, Uber).', pl: 'Auto segmentu B (np. Skoda Fabia) z instalacją LPG. Realne spalanie gazu 7-8 l/100 km. W pełni przygotowane na taksówkę (Bolt, Uber).', ru: 'Авто B-класса (напр. Skoda Fabia) с ГБО. Реальный расход газа 7-8 л/100 км. Полностью подготовлено для работы в такси (Bolt, Uber).', en: 'B-class car (e.g. Skoda Fabia) with LPG. Real gas consumption 7-8 l/100 km. Fully prepared for taxi work (Bolt, Uber).'},
