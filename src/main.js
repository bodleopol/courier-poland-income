...
(function() {
  ...
  const translations = {
    ...
    'bogdan.meta_title': { ua: 'Богдан Тютенко — Інвестор', pl: 'Bohdan Tiutenko — Inwestor', ru: 'Богдан Тютенко — Инвестор', en: 'Bohdan Tiutenko — Investor' },
    'bogdan.meta_description': { ua: 'Богдан Тютенко — Інвестор платформи Rybezh. Проживає у місті Львів.', pl: 'Bohdan Tiutenko — Inwestor platformy Rybezh. Mieszka we Lwowie.', ru: 'Богдан Тютенко — Инвестор платформы Rybezh. Проживает в городе Львов.', en: 'Bohdan Tiutenko — Investor of the Rybezh platform. Lives in Lviv.' },
