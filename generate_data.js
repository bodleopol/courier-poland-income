...
const bohdanProfile = {
  ...
  life: t(
    'Богдан Тютенко — операційний керівник у Foodtech і last-mile логістиці з понад 5 роками досвіду в Україні та Перу. У Rocket він керував City Operations під час активного масштабування платформи доставки, розвивав флот понад 150 курʼєрів, відповідав за операційний бюджет P&L, впроваджував SOPs і dashboards у Power BI та Excel, підтримуючи середній час доставки нижче 35 хвилин. У Lima він працював із dark kitchens, контролем FIFO/PEPS, виробництвом і dispatch-процесами, зменшуючи операційні втрати на 18% і підвищуючи пропускну здатність замовлень на 25%. У Yango він аналізував ефективність флоту, покращив видимість даних на 40%, сприяв зростанню SLA на 12% і підтримував безперервність сервісу на рівні 99.9%. Його сильна сторона для рекрутингу — поєднання P&L ownership, data analytics, кризового менеджменту, побудови команд і практичної логістики. Освіта: технік з обслуговування систем і компʼютерних мереж; інженерні студії в Донецьку були перервані через війну. Мови: українська та російська — рідні, іспанська — C1, англійська — B2.',
    'Bohdan Tiutenko is an operations leader in Foodtech and last-mile logistics with 5+ years of experience across Ukraine and Peru. At Rocket, he managed City Operations during aggressive delivery-platform scaling, grew a fleet of 150+ couriers, owned operating P&L, introduced SOPs and Power BI / Excel dashboards, and kept average delivery time under 35 minutes. In Lima, he worked with dark kitchens, FIFO/PEPS inventory control, production and dispatch workflows, reducing operational waste by 18% and increasing order-processing capacity by 25%. At Yango, he analysed fleet performance, improved data visibility by 40%, contributed to a 12% SLA improvement and maintained service continuity at 99.9%. His recruiting value is the combination of P&L ownership, data analytics, crisis management, team building and practical logistics execution. Education: computer systems and network maintenance technician; engineering studies in Donetsk were interrupted by the war. Languages: Ukrainian and Russian native, Spanish C1, English B2.',
    'Богдан Тютенко — операционный руководитель в Foodtech и last-mile логистике с опытом более 5 лет в Украине и Перу. В Rocket он управлял City Operations в период активного масштабирования платформы доставки, развивал флот более 150 курьеров, отвечал за операционный бюджет P&L, внедрял SOPs и dashboards в Power BI и Excel, удерживая среднее время доставки ниже 35 минут. В Лиме он работал с dark kitchens, контролем FIFO/PEPS, производством и dispatch-процессами, снижая операционные потери на 18% и повышая пропускную способность заказов на 25%. В Yango он анализировал эффективность флота, улучшил видимость данных на 40%, способствовал росту SLA на 12% и поддерживал непрерывность сервиса на уровне 99.9%. Его ценность для рекрутинга — сочетание P&L ownership, data analytics, кризисного менеджмента, построения команд и практической логистики. Образование: техник по обслуживанию систем и компьютерных сетей; инженерное обучение в Донецке было прервано войной. Языки: украинский и русский — родные, испанский — C1, английский — B2.',
    'Bohdan Tiutenko es un líder de operaciones en Foodtech y logística de última milla con más de 5 años de experiencia entre Ucrania y Perú. En Rocket gestionó City Operations durante una etapa de expansión agresiva de la plataforma de delivery, escaló una flota de +150 repartidores, asumió P&L operativo, implementó SOPs y dashboards en Power BI / Excel, manteniendo el tiempo promedio de entrega por debajo de 35 minutos. En Lima trabajó con dark kitchens, control de inventarios PEPS/FIFO, producción y despacho, reduciendo mermas operativas en 18% y aumentando la capacidad de procesamiento de órdenes en 25%. En Yango analizó rendimiento de flota, mejoró la visibilidad de datos en 40%, contribuyó a una mejora de SLA del 12% y mantuvo continuidad de servicio al 99.9%. Su valor para reclutamiento combina ownership de P&L, data analytics, gestión de crisis, construcción de equipos y ejecución logística práctica. Educación: técnico en mantenimiento de sistemas y redes informáticas; estudios de ingeniería en Donetsk interrumpidos por la guerra. Idiomas: ucraniano y ruso nativos, español C1, inglés B2.'
  ),
  tags: ['operations', 'leadership', 'logistics', 'analytics', 'foodtech', 'ukraine'],
  gallery: [
    {
  ...
  highlights: {
    uk: ['P&L ownership і зниження операційних витрат до 20%', 'Масштабування last-mile флоту понад 150 курʼєрів', 'Power BI, SQL, Excel, Kommo CRM, SOPs і KPI/OKR управління', 'Покращення SLA на 12% і безперервність сервісу 99.9%'],
    en: ['P&L ownership and operating-cost reduction up to 20%', 'Scaling last-mile fleets of 150+ couriers', 'Power BI, SQL, Excel, Kommo CRM, SOPs and KPI/OKR management', '12% SLA improvement and 99.9% service continuity'],
    ru: ['P&L ownership и снижение операционных затрат до 20%', 'Масштабирование last-mile флота более 150 курьеров', 'Power BI, SQL, Excel, Kommo CRM, SOPs и управление KPI/OKR', 'Улучшение SLA на 12% и непрерывность сервиса 99.9%'],
    es: ['Ownership de P&L y reducción de costos operativos hasta 20%', 'Escalamiento de flotas last-mile de +150 repartidores', 'Power BI, SQL, Excel, Kommo CRM, SOPs y gestión KPI/OKR', 'Mejora de SLA del 12% y continuidad de servicio al 99.9%']
  }
};
