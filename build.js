...
const translations = {
  uk: {
    ...
    footerPoliciesText: 'Редакційний формат: інформаційна база без doorway-сторінок і прихованого SEO-контенту.',
  ...
  en: {
    ...
    footerPoliciesText: 'Editorial format: informational knowledge base without doorway pages or hidden SEO content.',
  ...
  es: {
    ...
    footerPoliciesText: 'Formato editorial: base informativa sin páginas doorway ni contenido SEO oculto.',
  ...
  ru: {
    ...
    footerPoliciesText: 'Редакционный формат: информационная база без doorway-страниц и скрытого SEO-контента.',
    footerTeam: 'Команда: Rybezh.site',
