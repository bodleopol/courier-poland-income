...
const translations = {
  uk: {
    ...
    footerTeam: 'Редакція Rybezh.site · Олена Рибецька',
  ...
  en: {
    ...
    footerTeam: 'Rybezh.site editorial · Olena Rybetska',
  ...
  es: {
    ...
    footerTeam: 'Redacción Rybezh.site · Olena Rybetska',
  ...
  ru: {
    ...
    footerTeam: 'Редакция Rybezh.site · Елена Рыбецкая',
