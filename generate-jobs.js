...
const AGENCIES = [
  ...
  "QuickStaff Agency", "Reliable Workforce Poland", "Eastern European Staffing", "Polish Job Hub",
  "Career Connect Polska", "Success Staffing Group", "Eastern Talent Solutions", "Poland Employment Link",
  "Job Bridge International", "Central European Employment Services", "Polish Opportunity Center",
  "International Workers Poland", "EU Employment Network", "Polska Praca Solutions", "Cross-Border Staffing",
  "Eastern Workforce Connect", "Regional Employment Specialists", "Local Polish Jobs", "National Workforce Group",
  "Eastern European Personnel", "Transnational Staff Solutions", "Frontline Employment Services", "Polska Team Ltd.",
  "Polish Market Entry Staffing", "Skilled Trades Poland", "Industrial Workers Polska", "Professional Placement Polska",
  "Specialized Staffing Poland", "Eastern European Professionals", "Polish Career Connection", "Cross-Cultural Employment",
  "Global Polish Opportunities", "Polish Industry Leaders", "Trusted Polish Employment", "Eastern European Careers",
  "Poland Professional Staffing", "Regional Workforce Solutions", "Local Eastern Staffing", "International Polish Jobs",
  "Polish Employment Experts", "Eastern European Job Network", "Polish Market Staffing", "Central European Staffing Group",
  "Polish Employment Connection", "Eastern European Employment Services", "Polish Workforce Solutions", "Regional Polish Staffing",
  "Polish Job Specialists", "Eastern European Professional Staffing", "Polish Employment Network", "Trusted Polish Staffing",
  "Polish Professional Employment", "Eastern European Polish Jobs", "Polish Regional Staffing", "International Polish Employment",
  "Polish Local Employment", "Eastern European Regional Jobs", "Polish National Staffing", "European Polish Employment",
  "Polish Employment Group", "Eastern European Employment Solutions", "Polish Local Staffing", "Polish Regional Employment",
  "Polish National Employment", "Eastern European Professional Employment", "Polish Employment Specialists", "Regional Polish Employment",
  "Polish Professional Staffing", "Eastern European Local Staffing", "Polish Employment Solutions", "International Polish Staffing"
];
...
for (const cat of allCats) {
  ...
  for (const p of pool) {
    ...
    if (!citySet.has(p.city) && categoryCounts[cat] < perCat) {
